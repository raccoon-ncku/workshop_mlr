...
class Kr210(PyBulletRobot):
    ...
    def __init__(
        ...
        super().__init__(
            sim,
            body_name="KUKA KR210",
            file_name="robots/kuka_kr210_support/urdf/kr210l150.urdf",  # the path of the URDF file
...
if __name__ == "__main__":
    ...
    robot = Kr210(sim, control_type="joints")
