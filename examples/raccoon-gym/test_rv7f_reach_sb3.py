...
env = gym.make(ENV, control_type="joints", render_mode="human", renderer="Tiny")
...
model = model_class.load("logs/models/20240627152920/tqc_rv7f_reach_30000_steps.zip", env=env)
