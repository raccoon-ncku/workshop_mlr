...
env = gym.make("RaccoonKr300R2500UltraReach-v1", control_type="joints", render_mode="human", renderer="Tiny")
...
model = model_class.load("output/models/20240617142911/tqc_kuka_reach_30000_steps", env=env)
