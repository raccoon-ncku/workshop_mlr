...
env = gym.make("RaccoonKr3Reach-v1", control_type="joints", render_mode="human", renderer="Tiny")
...
model = model_class.load("logs/models/20240627143156/tqc_kuka_reach_30000_steps.zip", env=env)
